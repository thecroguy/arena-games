  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        answer: 'The referral program lets you earn real USDT by bringing new players to Arena Games. Unlike quest bonus credits, referral earnings are withdrawable directly to your wallet.\n\nGetting your referral link: Go to your Profile page and find the Referral section. Click Copy Link to copy your unique referral URL. This URL contains your wallet address as a parameter so any signups through it are tracked to you.\n\nHow a referral is counted: When someone visits Arena Games through your link for the first time, a referral tracking entry is stored in their browser session. When that player connects their wallet and completes their first paid match, the referral is confirmed and your earnings are credited automatically.\n\nWhat you earn: For each confirmed referral, you earn a USDT reward paid into your referral balance. This is real money. You can withdraw it directly to your wallet at any time from the Referral section of your profile. There is no minimum withdrawal amount and no expiry on referral earnings.\n\nReferral earnings vs quest credits: These are two separate things. Quest bonus credits (earned by playing milestones) are non-withdrawable and expire in 48 hours. Referral earnings are real USDT that sit in your referral balance until you choose to withdraw them.\n\nNo cap on referrals: There is no maximum number of players you can refer. Every confirmed referral adds to your withdrawable balance.\n\nTracking: The Referral section of your profile shows how many players have joined through your link, how many have completed a qualifying match, and your total referral earnings available to withdraw.'
      },
    ],
  },
  {
    ...
    articles: [
      {
        ...
        answer: 'Arena Games has two separate reward systems and it is important to understand the difference between them.\n\nQuest bonus credits (non-withdrawable): Earned by completing match milestones at a given entry fee level within a calendar month. For the $1 entry track: 5 matches unlocks $0.50, 15 matches unlocks $1.20, 30 matches unlocks $2.00, 50 matches unlocks $3.00. The $5 entry track has the same match thresholds but higher rewards. Quest credits can only be used as entry fees. They cannot be withdrawn. They expire 48 hours after being unlocked.\n\nReferral earnings (real withdrawable USDT): Earned when someone joins Arena Games through your referral link and completes their first paid match. These are real USDT credited to your referral balance on your profile. You can withdraw them directly to your wallet at any time. No expiry, no restrictions.\n\nHow quest credits work in a game: When you use a bonus credit as your entry fee, the credit is deducted from your balance instead of your wallet USDT. You still need MATIC for gas. If you win, the payout is still real USDT from the full pot contributed by both players.\n\nSummary: Quest credits let you play more games for free. Referral earnings are real money you can take out whenever you want.'
      },
      {
